...
DRONE_IP_2="192.168.42.1" #ip du drone
...
if __name__ == "__main__":
    # Création et démarrage des threads pour test_streaming et control_drone

    emergency()

    '''
    streaming_thread = threading.Thread(target=test_streaming)
    time.sleep(5)
