...
class StreamingExample:
    ...
    def yuv_frame_processing(self): 
        cv2.namedWindow("Drone Stream", cv2.WINDOW_NORMAL)  # Crée une fenêtre pour l'affichage
        while self.running:
            try:
            ...
            # Affichez le frame dans la fenêtre créée
            cv2.imshow("Drone Stream", bgr_frame)
            if cv2.waitKey(1) & 0xFF == ord('q'):  # Permet de quitter l'affichage en appuyant sur 'q'
                break
